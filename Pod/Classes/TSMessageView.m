...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        if ([subtitle length])
        {
            ...
            //MOKU MOD
            [self.contentLabel setAttributedText:subtitle];
            //END MOD
        ...
        if ([buttonTitle length])
        {
            ...
            [self.button setImage:buttonBackgroundImage forState:UIControlStateNormal];
            [self.button setImage:buttonBackgroundImage forState:UIControlStateHighlighted];
            // end mod
